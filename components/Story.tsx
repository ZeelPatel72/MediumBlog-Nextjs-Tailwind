...
function Story() {
	return (
		<div>
			<h2 className="uppercase text-xl py-5 px-10 pb-5 border-b">Detailed stories</h2>
			<div className="sm:grid md:grid-cols-1 xl:grid-cols-2 3xl:flex flex-wrap">
				<div className="flex flex-row py-5 px-3 pt-5 cursor-pointer items-center">
					<div className="basis-3/4 px-5 content-center">
						...
						<div className="flex pt-3 justify-between">
							<div className="flex">
								...
								<h4>20 min read</h4>
								<p className="text-3xl font-bold m-2 -mt-3.5">.</p>
								<h4 className=" bg-slate-200 px-4 rounded-full">Self-Reflection</h4>
							</div>
							<img className="w-7 h-7 rounded-full mr-3" src="Assets/save-logo.png" alt="" />
						</div>
					</div>
					<div className="basis-1/4 w-25">
						<img className="h-40 object-contain" src="Assets/story-1.jpg" alt="" />
					</div>
				</div>
				<div className="flex flex-row p-3 pt-5 cursor-pointer  items-center">
					...
					<div className="h-40 basis-1/4">
						<img className="object-contain" src="Assets/story-2.jpg" alt="" />
					</div>
				</div>
				<div className="flex flex-row p-3 pt-5 cursor-pointer  items-center">
					<div className="px-5 basis-3/4 content-center">
					...
					<div className="h-40 basis-1/4">
						<img className="object-contain" src="Assets/story-3.jpg" alt="" />
					</div>
				</div>
				<div className="flex flex-row p-3 pt-5 cursor-pointer  items-center">
					<div className="px-5 basis-3/4 content-center">
					...
					<div className="h-40 basis-1/4">
						<img className="object-contain" src="Assets/story-4.jpg" alt="" />
					</div>
				</div>
				<div className="flex flex-row p-3 pt-5 cursor-pointer  items-center">
					<div className="px-5 basis-3/4 content-center">
					...
					<div className="h-40 basis-1/4">
						<img className="object-contain" src="Assets/story-5.jpg" alt="" />
					</div>
				</div>
			</div>
		</div>
